...
namespace GameScene
{
    ...
    public class GroundController_2 : BaseController<GroundModel_2, GroundView_2>
    {
        ...
        private void Awake()
        {
            ...
            MessageManager.GetSingleton().RegisterMessageListener("OnTap_6", SendToPopupOverview);
        }
        ...
        private void OnDestroy()
        {
            ...
            MessageManager.GetSingleton().UnRegisterMessageListener("OnTap_6", SendToPopupOverview);
        }
