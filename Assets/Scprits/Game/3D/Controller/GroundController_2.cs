...
namespace GameScene
{
    ...
    /// 地块控制器二
    /// </summary>
    public class GroundController_2 : BaseController<GroundModel_2, GroundView_2>
    {
        ...
        private void Awake()
        {
            ...
            MessageManager.GetSingleton().RegisterMessageListener("OnTap_6", SendToPopupDetailed);
        }
        ...
        private void OnDestroy()
        {
            ...
            MessageManager.GetSingleton().UnRegisterMessageListener("OnTap_6", SendToPopupDetailed);
        }
