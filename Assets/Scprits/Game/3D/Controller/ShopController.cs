...
namespace GameScene {
    ...
    public class ShopController : BaseController<ShopModel, ShopView> {
        ...
        private void Awake()
        {
            ...
            MessageManager.GetSingleton().RegisterMessageListener("OnTap_1", SendToPopupOverview);

            MessageManager.GetSingleton().RegisterMessageListener("Building_1", Building);
        }
        ...
        private void OnDestroy()
        {
            ...
            MessageManager.GetSingleton().UnRegisterMessageListener("OnTap_1", SendToPopupOverview);

            MessageManager.GetSingleton().UnRegisterMessageListener("Building_1", Building);
        }
