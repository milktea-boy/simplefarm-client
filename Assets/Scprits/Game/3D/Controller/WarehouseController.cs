...
namespace GameScene {
    ...
    public class WarehouseController : BaseController<WarehouseModel, WarehouseView> {
        ...
        private void Awake()
        {
            ...
            MessageManager.GetSingleton().RegisterMessageListener("OnTap_2", SendToPopupOverview);

            MessageManager.GetSingleton().RegisterMessageListener("Building_2", Building);
        }
        ...
        private void OnDestroy()
        {
            ...
            MessageManager.GetSingleton().UnRegisterMessageListener("OnTap_2", SendToPopupOverview);

            MessageManager.GetSingleton().UnRegisterMessageListener("Building_2", Building);
        }
