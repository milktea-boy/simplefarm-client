...
namespace GameScene {
    ...
    public class WarehouseController : BaseController<WarehouseModel, WarehouseView> {
        ...
        private void Awake()
        {
            ...
            MessageManager.GetSingleton().RegisterMessageListener("OnTap_2", SendToPopupDetailed);
        }
        ...
        private void OnDestroy()
        {
            ...
            MessageManager.GetSingleton().UnRegisterMessageListener("OnTap_2", SendToPopupDetailed);
        }
