...
namespace GameScene {
    ...
    public class WellController : BaseController<WellModel, WellView> {
        ...
        private void Awake()
        {
            ...
            MessageManager.GetSingleton().RegisterMessageListener("OnTap_7", SendToPopupDetailed);
        }
        ...
        private void OnDestroy()
        {
            ...
            MessageManager.GetSingleton().UnRegisterMessageListener("OnTap_7", SendToPopupDetailed);
        }
