...
namespace GameScene {
    ...
    public class WellController : BaseController<WellModel, WellView> {
        ...
        private void Awake()
        {
            ...
            MessageManager.GetSingleton().RegisterMessageListener("OnTap_7", SendToPopupOverview);

            MessageManager.GetSingleton().RegisterMessageListener("Building_7", Building);
        }
        ...
        private void OnDestroy()
        {
            ...
            MessageManager.GetSingleton().UnRegisterMessageListener("OnTap_7", SendToPopupOverview);

            MessageManager.GetSingleton().UnRegisterMessageListener("Building_7", Building);
        }
